...
namespace PureLifeClinic.Infrastructure.Migrations
{
    ...
    [Migration("20250517021832_update_v15")]
    partial class update_v15
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PureLifeClinic.Core.Entities.General.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PureLifeClinic.Core.Entities.General.Doctor", b =>
                {
                    ...
                    b.Property<int>("SuccessfulPatients")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PureLifeClinic.Core.Entities.General.Feedback.ClinicFeedBack", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ClinicFeedBacks");
                });

            modelBuilder.Entity("PureLifeClinic.Core.Entities.General.Feedback.DoctorFeedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PureLifeClinic.Core.Entities.General.Feedback.HealthServiceFeedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("HealthServiceFeedbacks");
                });
            ...
            modelBuilder.Entity("PureLifeClinic.Core.Entities.General.Invoice", b =>
                {
                    ...
                    b.Property<string>("FilePathPublicId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PureLifeClinic.Core.Entities.General.MedicalFile", b =>
                {
                    ...
                    b.Property<int?>("AppointmentHealthServiceId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AppointmentHealthServiceId");
            ...
            modelBuilder.Entity("PureLifeClinic.Core.Entities.General.Queues.Counter", b =>
                {
                    ...
                    b.Property<string>("CurrentQueueNumber")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PureLifeClinic.Core.Entities.General.Room", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PureLifeClinic.Core.Entities.General.RoomType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PureLifeClinic.Core.Entities.General.User", b =>
                {
                    ...
                    b.Property<string>("ImagePathPublicId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PureLifeClinic.Core.Entities.General.AppointmentHealthService", b =>
                {
                    ...
                    b.HasOne("PureLifeClinic.Core.Entities.General.Room", "Room")
                        .WithMany()
            ...
            modelBuilder.Entity("PureLifeClinic.Core.Entities.General.Doctor", b =>
                {
                    b.HasOne("PureLifeClinic.Core.Entities.General.Room", "WorkingRoom")
                        .WithMany()
                        .HasForeignKey("RoomId");
            ...
            modelBuilder.Entity("PureLifeClinic.Core.Entities.General.MedicalFile", b =>
                {
                    b.HasOne("PureLifeClinic.Core.Entities.General.AppointmentHealthService", "AppointmentHealthService")
                        .WithMany("MedicalFiles")
                        .HasForeignKey("AppointmentHealthServiceId");
                    ...
                    b.Navigation("AppointmentHealthService");
            ...
            modelBuilder.Entity("PureLifeClinic.Core.Entities.General.Room", b =>
                {
                    b.HasOne("PureLifeClinic.Core.Entities.General.RoomType", "RoomType")
                        .WithMany("Rooms")
