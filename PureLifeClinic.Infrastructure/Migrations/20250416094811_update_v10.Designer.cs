...
namespace PureLifeClinic.Infrastructure.Migrations
{
    ...
    [Migration("20250416094811_update_v10")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PureLifeClinic.Core.Entities.General.Feedback.Feedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PureLifeClinic.Core.Entities.General.Feedback.ClinicFeedBack", b =>
                {
                    b.HasBaseType("PureLifeClinic.Core.Entities.General.Feedback.Feedback");

                    b.HasDiscriminator().HasValue("ClinicFeedBack");
                });
            ...
            modelBuilder.Entity("PureLifeClinic.Core.Entities.General.Feedback.DoctorFeedback", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("DoctorFeedback");
                });
            ...
            modelBuilder.Entity("PureLifeClinic.Core.Entities.General.Feedback.HealthServiceFeedback", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("HealthServiceFeedback");
                });
