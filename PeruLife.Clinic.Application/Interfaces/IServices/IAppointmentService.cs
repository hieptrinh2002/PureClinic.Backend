...
namespace PureLifeClinic.Application.Interfaces.IServices
{
    public interface IAppointmentService : IBaseService<AppointmentViewModel>
    {
        ...
        Task<ResponseViewModel<AppointmentViewModel>> UpdateAppointmentAsync(int id, AppointmentUpdateViewModel model, CancellationToken cancellationToken);
        ...
        Task<List<AppointmentHealthServiceVM>> AssignServiceToAppointment(int appointmentId, List<AppointmentHealthServiceCreateVM> model, CancellationToken cancellationToken);
        Task<List<AppointmentHealthServiceVM>> GetAppointmentHealthService(int appointmentId, int serviceId, CancellationToken cancellationToken);
